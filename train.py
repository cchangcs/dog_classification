...
train, train_label, val, val_label = prepare_imgs.get_files(train_dir, 0.3)
# 训练数据及标签
train_batch, train_label_batch = prepare_imgs.get_batch(train, train_label, IMG_W, IMG_H, BATCH_SIZE, CAPACITY)
# 测试数据及标签
val_batch, val_label_batch = prepare_imgs.get_batch(val, val_label, IMG_W, IMG_H, BATCH_SIZE, CAPACITY)
